...
app.get('/recipes', async (req, res) => {
    ...
    let targetUrl5 = 'https://www.allrecipes.com/recipe/9247/christmas-breakfast-sausage-casserole/?internalSource=hub%20recipe&referringContentType=Search';
    const response = await axios.get(targetUrl5);
